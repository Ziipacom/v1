...
export default function Portal() {
  ...
  async function submit(event: FormEvent<HTMLFormElement>) {
    ...
    try { await api(`/auth/${mode}`, data); await refresh(); }
